                ...
                <nav className="navbar navbar-expand-lg navbar-light ">
                    <div className="container-fluid">
                        ...
                        <ul className="navbar-nav mb-2 mb-lg-0" style={{marginLeft: "auto",}}>
                            ...
                            <li className="nav-item">
                            <NavLink activeClassName="menu_active" className="nav-link" exact to="/service">Algorithms</NavLink>
                            </li>
                            <li className="nav-item">
                            <NavLink activeClassName="menu_active" className="nav-link" exact to="/about">Visualize</NavLink>
                            </li>
                            <li className="nav-item">
